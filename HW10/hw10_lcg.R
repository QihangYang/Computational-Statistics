...
g1 <- ggplot(data = unif_pairs, mapping = aes(x = X1, y = X2)) +
  geom_point() +
...
## Do not modify this line!
g2 <- ggplot(data = exp_rng, mapping = aes(x = E)) +
  geom_histogram(aes(y = ..density..), fill = "white", color = "black") +
  geom_density(aes(color = "Simulated")) +
  stat_function(fun = dexp, args = list(1.5), aes(color = "Theoretical")) +
...
## Do not modify this line!
t6 <- gather(data = norm_rng)
g3 <- ggplot(data = t6, mapping = aes(x = value)) +
  geom_histogram(aes(y = ..density..), fill = "white", color = "black") +
  geom_density(aes(color = "Simulated")) +
  stat_function(fun = dnorm, args = list(0,1), aes(color = "Theoretical")) +
  facet_wrap( ~key) +
